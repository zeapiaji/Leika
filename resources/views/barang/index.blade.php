    ...
    <div class="card">
        <div class="card-body">
            <div class="row align-item-center">
                <div class="col-6">
                    <div class="d-flex">
                        <a href="{{route('export.excel')}}" class="btn btn-md btn-success"><i class="uil-table me-2" style="font-size: "></i> Excel</a>
                        <a href="{{route('export.pdf')}}" class="btn btn-md btn-danger ms-2"><i class="uil-file-copy-alt me-2"></i> PDF</a>
                    </div>
                </div>
                        ...
                        <tr role="row " class="odd">
                            ...
                            <td class="col-1 text-center">
                                <div class="d-flex gap-1">
                                    ...
                                    <a href="{{route('hapus.kamera', $item->id)}}" class="btn btn-outline-danger" onclick="hapus_kamera({{$item->id}})"><i
                                            class="fas fa-trash-alt"></i></a>
                                    @else
                                    <a href="{{route('edit.lensa', $item->id)}}" class="btn btn-outline-success"><i
                                            class="fas fa-pencil-alt"></i></a>
                                    <button type="button" class="btn btn-outline-danger" onclick="hapus_lensa({{$item->id}})">
                                        <i class="fas fa-trash-alt"></i></button>
                                    @endif
{{-- 
    $status = User::where('status', 1)->count()
